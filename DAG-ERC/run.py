...
if __name__ == '__main__':
    ...
    parser.add_argument('--hybrid_curriculum', action='store_true', default=False, help='Enables tensorboard log')
    ...
    for e in range(n_epochs):
        ...
        if e + 1 < args.bucket_number:
            train_loader = get_train_loader(dataset_name=args.dataset_name, batch_size=batch_size, num_workers=0, args = args, babystep_index=e+1)
        else:
